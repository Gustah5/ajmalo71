#!/usr/bin/python3
#-*-coding:utf-8-*-
# Made With ❤️ By Nazir & Ajmal
# Update V0.1

# Copyright© Nazir ID 2021
# 100% Open Source Code

# Author : Nazir ajmal
# Facebook (Nazir)   : https://www.facebook.com/NaZerkhaN521
# Warning (☬ Mr Nazir ☬)    : Tricker Toor ajmal
# Whatsapp (Mr Nazir)      : +923025669420
# Warning (Nazir)           : FeeL yOur AjMaL DaDx
...
_logo_line_3_ = ('%s======== ========    ===   === ======= %s│   %s• Code By Nazir Khan  •   %s│'%(_P_,_U_,_P_,_U_))
_logo_line_4_ = ('%s=== ==== ===  ===  ===     === === ===  %s│ %sGithubhttps://github.com/Gustah5/ %s│'%(_P_,_U_,_P_,_U_))
_logo_line_5_ = ('%s===  === ===  === ======== === ===  ===└─────────────────────────┘'%(_U_))
def _my_logo_():
